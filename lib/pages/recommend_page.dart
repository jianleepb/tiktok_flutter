            ...
            child: Container(
              ...
              child:Expanded(
                child: Column(
                  ...
                  children: [
                    _attentionIcon('https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3196884682,1526664447&fm=26&gp=0.jpg'),
                    _getIcons(0,'4544'),
                    _getIcons(1,'2042'),
                    _getIcons(2,'665'),
                  ],
  ...
  Widget _getIcons(int index,String num){
    return Container(
      ...
      child: Column(
        children: [
          SizedBox(height: 7,),
          Icon(icons[index], color: white, size: 35.0),
          SizedBox(height: 2,),
          Text(num,style: TextStyle(color: Colors.white,fontSize: 12),),
          SizedBox(height: 7,)
        ],
      ),
    );
